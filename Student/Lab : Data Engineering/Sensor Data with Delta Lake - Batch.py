...
# MAGIC %sql
# MAGIC ALTER TABLE sensor_readings_historical_silver_with_constraints DROP CONSTRAINT IF EXISTS reading_1_check;
# MAGIC ALTER TABLE sensor_readings_historical_silver_with_constraints DROP CONSTRAINT IF EXISTS reading_2_check;
# MAGIC ALTER TABLE sensor_readings_historical_silver_with_constraints DROP CONSTRAINT IF EXISTS reading_3_check ;
